...
const TopBar = (props) => {
  ...
  const { history, toggleTheme, toggleLang, currentLang, isDarkTheme } = props;
                ...
                (
                  <div >
                    ...
                    <Menu
                      ...
                      <MenuItem onClick={() => handleMenuClick("/")}><HomeIcon className={classes.iconBurgerStyle} />Home</MenuItem>
                ...
                (
                  <nav className="navbar">
                    <ul className="navbar__list">
                      ...
                      <li className="navbar__item">
                        <NavLink to="/login"><Button className={classes.buttonText}>{LangsTranslate[currentLang].navbar.sign_in}</Button></NavLink>
                      </li>
                      <li className="navbar__item">
                        <NavLink to="/register"><Button className={classes.buttonText}>{LangsTranslate[currentLang].navbar.sign_up}</Button></NavLink>
                      </li>
