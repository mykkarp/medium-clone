...
import TagsBar from "pages/MainPage/TagsBar/TagsBar.js";
      ...
      <Container style={{ maxWidth: "1124px" }}>
        ...
        >
          <Paper style={isPlanshet ? null : { margin: "0px 20px 0px 0px" }} className={styles.paper}>
            <Tabs currentPage="mainPage" currentLang={currentLang} />
          </Paper>
          <TagsBar currentLang={currentLang} isPlanshet={isPlanshet} />
        </div>
      </Container>
    </section>
  )
