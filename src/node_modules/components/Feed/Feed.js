...
export default function RecipeReviewCard(props) {
  ...
  const { currentLang, articleDesc, articleOwner, articleTags, articleText, articleTitle, dislikes, likes, publishedDate, articleOwnerPhoto } = props;
  // const isPhone =   useMediaQuery('(max-width:403px)');
        ...
        action={
          <div style={{ margin: "15px 0px 0px 0px", display: "flex", flexWrap: "wrap", rowGap: "5px" }}>
            ...
            >
              ...
              <span>{(10).toLocaleString("en")}</span>
            </IconButton>
            <div>
              <IconButton
                aria-label="like"
