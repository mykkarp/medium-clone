...
export default function RecipeReviewCard({ commentText, dislikes, likes, owner, publishedDate, articleId, deleteCommentHandler, articleOwnerId }) {
        ...
        <div style={{ margin: "10px 0px 0px 0px" }}>
          {localStorage.getItem("currentUserId") === owner || localStorage.getItem("currentUserId") === articleOwnerId ?
            <IconButton
              ...
              className={styles.iconButtons}
              component="span"
              onClick={() => deleteCommentHandler(publishedDate)}
            >
              <DeleteIcon />
            </IconButton> :
            null}
