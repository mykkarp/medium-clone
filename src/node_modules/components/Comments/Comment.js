...
export default function RecipeReviewCard({ commentText, dislikes, likes, owner, publishedDate, articleId }) {
  ...
  const dislikeHandler = () => {
    ...
    if (usersDisliked.find(e => e === localStorage.getItem("currentUserId"))) {
      const timestamp = likeTimestamp[usersDisliked.indexOf(localStorage.getItem("currentUserId"))]
