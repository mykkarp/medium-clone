...
const Article = (props) => {
  ...
  // console.log(article && stateToHTML(convertFromRaw(JSON.parse(article.articleText))));
  console.log(article && article.articleText);
                ...
                <CardContent style={{ padding: "8px 16px 16px" }}>
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={
                      { __html: stateToHTML(convertFromRaw(JSON.parse(article.articleText))) }
                    }
                  >
                    {/*article text*/}
                  </div>
