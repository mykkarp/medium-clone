                  ...
                  <nav className="navbar">
                    <ul className="navbar__list">
                      <li className="navbar__item">
                        <NavLink tabIndex="-1" to="/medium-clone/" exact><Button startIcon={<HomeIcon />} className={classes.buttonText}>{LangsTranslate[currentLang].navbar.home}</Button></NavLink>
                      </li>

                      {!localStorage.getItem("currentUserId") &&
                        <>
                          <li className="navbar__item">
                            <NavLink tabIndex="-1" to="/medium-clone/login"><Button className={classes.buttonText}>{LangsTranslate[currentLang].navbar["sign-in"]}</Button></NavLink>
                          </li>
                          <li className="navbar__item">
                            <NavLink tabIndex="-1" to="/medium-clone/register"><Button className={classes.buttonText}>{LangsTranslate[currentLang].navbar["sign-up"]}</Button></NavLink>
                          </li>
                        </>
                      }
                      ...
                      {localStorage.getItem("currentUserId") &&
                        <>
                          <li className="navbar__item">
                            <NavLink tabIndex="-1" to="/medium-clone/new">
                              <Button startIcon={<PostAddIcon />} className={classes.buttonText}>{LangsTranslate[currentLang].navbar["new-post"]}</Button>
                            </NavLink>
                          </li>
                          <li className="navbar__item">
                            <NavLink tabIndex="-1" to={`/medium-clone/profiles/${localStorage.getItem("currentUserId")}`}>
