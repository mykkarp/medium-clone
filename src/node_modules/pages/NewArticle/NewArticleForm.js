...
import MuiRteTest from "pages/NewArticle/MuiRteTest.js";
...
function NewArticleForm(props) {
  ...
  // console.log(!!articleText.match(/(<.+><\/.+>|^\s*$)/g));
