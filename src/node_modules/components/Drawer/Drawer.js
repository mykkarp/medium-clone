...
export default function TemporaryDrawer({ toggleTheme, toggleLang, currentLang, isDarkTheme, userName }) {
          ...
          {localStorage.getItem("currentUserId") &&
            <>
              ...
              <NavLink to={`/profiles/${localStorage.getItem("currentUserId")}`}>
                <ListItem button className={isDarkTheme ? classes.buttonTextWhite : classes.buttonTextDark}>
                  <ListItemIcon><Avatar style={{ width: "27px", height: "27px", margin: "0px 5px 0px 0px" }}></Avatar></ListItemIcon>
                  <ListItemText primary={userName || <Loader />} />
                </ListItem>
              </NavLink>
            </>
          }
